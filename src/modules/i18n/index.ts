...
export const translations: Record<AppLanguage, LanguageDictionary> = {
  en: {
    ...
    chat: {
      ...
      deleteChatCurrentUserOnlyNote:
        'Retire this direct chat for both participants. Opening a new DM later starts a clean conversation.',
      deleteChatConfirmTitle: 'Delete this direct chat',
      deleteChatConfirmBody:
        'This retires the current direct chat and removes its current history for both participants.',
      deleteChatConfirmHint: 'Type "Удалить" to confirm.',
      deleteChatConfirmPlaceholder: 'Удалить',
      deleteChatConfirmButton: 'Delete for both sides',
  ...
  ru: {
    ...
    chat: {
      ...
      deleteChatCurrentUserOnlyNote:
        'Полностью убрать этот личный чат для обоих участников. Если открыть новый DM позже, создастся чистый разговор.',
      deleteChatConfirmTitle: 'Удалить этот личный чат',
      deleteChatConfirmBody:
        'Это полностью снимет текущий личный чат и его текущую историю сообщений для обоих участников.',
      deleteChatConfirmHint: 'Введите "Удалить", чтобы подтвердить.',
      deleteChatConfirmPlaceholder: 'Удалить',
      deleteChatConfirmButton: 'Удалить для обеих сторон',
